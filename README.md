...
> [`reproducr`](https://github.com/ndohpenngit/reproducr) with `renv` —
...
| | [reproducr-example](https://github.com/ndohpenngit/reproducr-example) | this repo |
|---|---|---|
...
See also: [`reproducr-example`](https://github.com/ndohpenngit/reproducr-example)
